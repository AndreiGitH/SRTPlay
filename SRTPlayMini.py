...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "This biblical scene, that bring emotion and a beautiful look, set against a beautiful ancient Middle Eastern backdrop. . The prompt should end with the quality parameters."
        f"\n\nScene:\n{texto}\n\nQuality parameters:\n{STYLE_SUFFIX}"
    )
    try:
