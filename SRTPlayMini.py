...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "This scene with no text, no hands, no chairs, no sofa, no armchair, no tree, in the context for seniors, focus on food, parts of the body and health. The prompt should end with the quality parameters."
