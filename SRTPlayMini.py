...
STYLE_SUFFIX = (
    ...
    "cartoon drawing style, elderly characters, wide shot, no text overlay." 
)
# ─── session_state ─────────────────────────────
...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "This scene, that bring emotion and a beautiful look, bright and sharpness, few bright particles, set against a beautiful backdrop. Face emotion when its important. The prompt should end with the quality parameters."
        f"\n\nScene:\n{texto}\n\nQuality parameters:\n{STYLE_SUFFIX}"
    )
    try:
