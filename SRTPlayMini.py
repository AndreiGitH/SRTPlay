...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "This scene with no text, no hands, no chairs, no sofa, no armchair, no tree, no fish, in the context for seniors, on food that eat in the morning, muscles strength. Dont exagerate in the quantity. The prompt should end with the quality parameters."
