...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        #"This biblical scene, that bring emotion and a beautiful look, bright and sharpness, bright spots, set against a beautiful ancient Middle Eastern backdrop. Face emotion when its important. The prompt should end with the quality parameters."
