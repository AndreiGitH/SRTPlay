...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "This scene with no text, no hands, no chairs, no sofa, no armchair, no tree, no fish, in the context of health diet for seniors. Choose: brain, muscles, legs, heart, senior walking, senior exercise, according to the context. Realistic. The prompt should end with the quality parameters."
