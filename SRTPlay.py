...
# ─── Configurações ─────────────────────────────
STYLE_SUFFIX = (
    "Ultra-realistic, cinematic lighting, volumetric light, dramatic contrast, golden light "
...
def gerar_prompt(client_txt, texto: str) -> str:
    pedido = (
        ...
        "this biblical scene. If it has a character, make a medium close-up. The prompt must end with the quality parameters and explicitly "
